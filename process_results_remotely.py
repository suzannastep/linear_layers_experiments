...
def make_sbatch(Ls,rs,ns,wds,labelnoise,epochs,job_name,architecture,path):
    job_file = f"process_{job_name}"
    params  = "--Ls {} --rs {} --ns {} --wds {} --labelnoise {} --epochs {} --job_name {} --architecture {} --path {}"
    params = params.format(Ls,rs,ns,wds,labelnoise,epochs,job_name,architecture,path)
